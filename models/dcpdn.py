...
class G(nn.Module):
    def __init__(self, input_nc, output_nc, nf):
        ...
        # todo: out_channels changed here
        self.conv1010 = nn.Conv2d(20, 3, kernel_size=1, stride=1, padding=0)  # 1mm
        self.conv1020 = nn.Conv2d(20, 3, kernel_size=1, stride=1, padding=0)  # 1mm
        self.conv1030 = nn.Conv2d(20, 3, kernel_size=1, stride=1, padding=0)  # 1mm
        self.conv1040 = nn.Conv2d(20, 3, kernel_size=1, stride=1, padding=0)  # 1mm
    ...
    def forward(self, x):
        ...
        # print(shape_out)
        shape_out = shape_out[2:4]          # check it out

        x101 = F.avg_pool2d(dout1, 16)      # 32
        x102 = F.avg_pool2d(dout1, 8)       # 16
        x103 = F.avg_pool2d(dout1, 4)       # 8
        x104 = F.avg_pool2d(dout1, 2)       # 4
